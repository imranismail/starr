...
configure:
	@RADARR_API_KEY=$(RADARR_API_KEY) SERIES_SONARR_API_KEY=$(SERIES_SONARR_API_KEY) ANIME_SONARR_API_KEY=$(ANIME_SONARR_API_KEY) PROWLARR_API_KEY=$(PROWLARR_API_KEY) scripts/configure.sh
